...
module Map
  ...
  OBJECTS = {
    ID_NINJA              => { pref:  4, att: 2, old:  0, pal:  6, states: 1, name: 'ninja'              },
    ID_MINE               => { pref: 22, att: 2, old:  1, pal: 10, states: 3, name: 'mine'               },
    ID_GOLD               => { pref: 21, att: 2, old:  2, pal: 14, states: 1, name: 'gold'               },
    ID_EXIT               => { pref: 25, att: 4, old:  3, pal: 17, states: 2, name: 'exit door'          },
    ID_EXIT_SWITCH        => { pref: 20, att: 0, old: -1, pal: 25, states: 2, name: 'exit switch'        },
    ID_DOOR_REGULAR       => { pref: 19, att: 3, old:  4, pal: 30, states: 2, name: 'regular door'       },
    ID_DOOR_LOCKED        => { pref: 28, att: 5, old:  5, pal: 31, states: 2, name: 'locked door'        },
    ID_DOOR_LOCKED_SWITCH => { pref: 27, att: 0, old: -1, pal: 33, states: 2, name: 'locked door switch' },
    ID_DOOR_TRAP          => { pref: 29, att: 5, old:  6, pal: 39, states: 2, name: 'trap door'          },
    ID_DOOR_TRAP_SWITCH   => { pref: 26, att: 0, old: -1, pal: 41, states: 2, name: 'trap door switch'   },
    ID_LAUNCHPAD          => { pref: 18, att: 3, old:  7, pal: 47, states: 1, name: 'launch pad'         },
    ID_ONEWAY             => { pref: 24, att: 3, old:  8, pal: 49, states: 1, name: 'one-way platform'   },
    ID_DRONE_CHAINGUN     => { pref: 16, att: 4, old:  9, pal: 51, states: 1, name: 'chaingun drone'     },
    ID_DRONE_LASER        => { pref: 17, att: 4, old: 10, pal: 53, states: 1, name: 'laser drone'        },
    ID_DRONE_ZAP          => { pref: 15, att: 4, old: 11, pal: 57, states: 1, name: 'zap drone'          },
    ID_DRONE_CHASER       => { pref: 14, att: 4, old: 12, pal: 59, states: 1, name: 'seeker drone'       },
    ID_FLOORGUARD         => { pref: 13, att: 2, old: 13, pal: 61, states: 1, name: 'floorguard'         },
    ID_BOUNCEBLOCK        => { pref:  3, att: 2, old: 14, pal: 63, states: 1, name: 'bounce block'       },
    ID_ROCKET             => { pref:  8, att: 2, old: 15, pal: 65, states: 1, name: 'rocket launcher'    },
    ID_GAUSS              => { pref:  9, att: 2, old: 16, pal: 69, states: 1, name: 'gauss turret'       },
    ID_THWUMP             => { pref:  6, att: 3, old: 17, pal: 74, states: 1, name: 'thwump'             },
    ID_TOGGLE_MINE        => { pref: 23, att: 2, old: 18, pal: 10, states: 3, name: 'toggle mine'        },
    ID_EVIL_NINJA         => { pref:  5, att: 2, old: 19, pal: 77, states: 1, name: 'evil ninja'         },
    ID_LASER_TURRET       => { pref:  7, att: 4, old: 20, pal: 79, states: 1, name: 'laser turret'       },
    ID_BOOST_PAD          => { pref:  1, att: 2, old: 21, pal: 81, states: 1, name: 'boost pad'          },
    ID_DEATHBALL          => { pref: 10, att: 2, old: 22, pal: 83, states: 1, name: 'deathball'          },
    ID_MICRODRONE         => { pref: 12, att: 4, old: 23, pal: 57, states: 1, name: 'micro drone'        },
    ID_MINI               => { pref: 11, att: 2, old: 24, pal: 86, states: 1, name: 'mini'               },
    ID_SHOVE_THWUMP       => { pref:  2, att: 2, old: 25, pal: 88, states: 3, name: 'shove thwump'       }
  }
