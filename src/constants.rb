...
SUPPORTED_COMMANDS = [:browse, :config, :download, :screenshot, :video]
DISABLED_COMMANDS = []
...
PATH_MAPPACK_INFO = "#{DIR_MAPPACKS}/digest.json"
...
UPDATE_STEAM      = false # Thread to regularly fetch new N++ patches from Steam's API
...
UPDATE_VIDEOS     = false # Thread to regularly fetch and parse the video library
...
UPDATE_USER_INFO  = false # Thread to continuously re-download userlevel data (favs, name changes, ...)
...
MAPPACK_DIGEST    = false # Thread to regularly update the general mappack digest

# Update frequencies for each task, in seconds
STATUS_UPDATE_FREQUENCY     =             5 * 60 # See UPDATE_STATUS
TWITCH_UPDATE_FREQUENCY     =                 60 # See UPDATE_TWITCH
SPEEDRUN_UPDATE_FREQUENCY   =                 60 # See UPDATE_SPEEDRUN
RSS_UPDATE_FREQUENCY        =                 60 # See UPDATE_RSS
STEAM_UPDATE_FREQUENCY      =             5 * 60 # See UPDATE_STEAM
HIGHSCORE_UPDATE_FREQUENCY  =       24 * 60 * 60 # See UPDATE_SCORES
DEMO_UPDATE_FREQUENCY       =       24 * 60 * 60 # See UPDATE_DEMOS
VIDEO_UPDATE_FREQUENCY      =       24 * 60 * 60 # See UPDATE_VIDEOS
LEVEL_UPDATE_FREQUENCY      =       24 * 60 * 60 # See POST_LOTD, POST_EOTW and POST_COTM
CTP_LEVEL_FREQUENCY         =       24 * 60 * 60 # See POST_CTP_LOTD, POST_CTP_EOTW and POST_CTP_COTM
REPORT_UPDATE_SIZE          =   7 * 24 * 60 * 60 # How many days to include in the report (see REPORT_METANET)
SUMMARY_UPDATE_SIZE         =   1 * 24 * 60 * 60 # How many days to include in the summary (see REPORT_METANET)
USERLEVEL_SCORE_FREQUENCY   =       24 * 60 * 60 # See UPDATE_USERLEVELS
USERLEVEL_UPDATE_RATE       =                 10 # See UPDATE_USER_GLOB
USERLEVEL_DATA_RATE         =        1 * 60 * 60 # See UPDATE_USER_INFO
USERLEVEL_REPORT_FREQUENCY  =       24 * 60 * 60 # See REPORT_USERLEVELS
USERLEVEL_TAB_FREQUENCY     =       24 * 60 * 60 # See UPDATE_USER_TABS
USERLEVEL_DOWNLOAD_CHUNK    =                100 # Userlevel batch size when updating scores globally
FRACTION_FREQUENCY          =                 60 # See COMPUTE_FRACTIONS
MAPPACK_DIGEST_FREQUENCY    =        1 * 60 * 60 # See MAPPACK_DIGEST
...
STEAM_TOKEN_GRACE   = 7          # How many days before a refresh token expires to send out a warning to Discord
